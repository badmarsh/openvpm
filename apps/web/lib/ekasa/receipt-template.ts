...
<head>
  ...
  <style>
    /* ---------------------------------------------------------- */
    /* Základné štýly — optimalizované pre 80mm termálnu tlačiareň */
    /* ---------------------------------------------------------- */
...
<body>
  ...
  <!-- KRYPTOGRAFICKÉ KÓDY (legislatívna požiadavka) -->
  ...
  <!-- QR KÓD (overenie na portáli FR SR) -->
  <div class="qr-section">
    <!-- QR kód vygenerovaný na klientovi (použiť qrcode.js alebo server-side) -->
