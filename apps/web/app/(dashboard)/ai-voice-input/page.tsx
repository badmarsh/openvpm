    ...
    const setupMediaRecorder = async () => {
      try {
        ...
        recorder.onstart = () => {
          ...
          // @ts-expect-error - Web Speech API types may not be available
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="text-center py-12">
                <button
                  ...
                  className={`w-24 h-24 rounded-full flex items-center justify-center text-white text-2xl focus:outline-none focus:ring-4 transition-all duration-200 ${isRecording
